...
<div class="container-fluid">
    <div class="row">
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Nike Zoom Gravity.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Nike Zoom Gravity Feminino-Branco e Lilás </h5>
                    <p class="card-text">R$ 399,99
                        até 10x de R$ 40,00</p>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Adidas Solar Glide.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Adidas Solar Glide Boost Masculino - Preto e Pink</h5>
                    <p class="card-text">R$ 399,00
                        até 10x de R$ 39,90</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Nike Renew Run Masculino.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Nike Renew Run Masculino-Azul e Chumbo</h5>
                    <p class="card-text">R$ 399,99
                        até 10x de R$ 40,00</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
