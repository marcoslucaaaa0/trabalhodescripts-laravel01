...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Célula Company.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Célula Company Memb Masculino - Marrom</h5>
                    <p class="card-text">R$ 179,90
                        até 4x de R$ 44,98</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Nike Sb Check.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Nike Sb Check Solar Cnvs Masculino - Azul e Roxo</h5>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Mary Jane High.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Mary Jane High School Couro Feminino - Nude e branco</h5>
                    <p class="card-text">R$ 191,92
                        até 4x de R$ 47,98</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
