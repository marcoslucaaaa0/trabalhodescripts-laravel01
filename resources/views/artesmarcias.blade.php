...
<div class="container-fluid">
    <div class="row">
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Everlast Jump IV Masculino - Preto.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Everlast Jump IV Masculino - Preto</h5>
                    <p class="card-text">R$ 119,99
                        até 3x de R$ 40,00</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Everlast Station Masculino - Cinza e Branco.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Everlast Station Masculino - Cinza e Branco</h5>
                    <p class="card-text">R$ 129,99
                        até 3x de R$ 43,33</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Everlast Station Masculino - Marinho e Branco.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Everlast Station Masculino - Marinho e Branco</h5>
                    <p class="card-text">R$ 139,99
                        até 3x de R$ 46,66</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
