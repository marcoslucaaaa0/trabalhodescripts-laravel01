...
<div class="container-fluid">
    <div class="row">
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis AND1 Thunder Masculino - Preto.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis AND1 Thunder Masculino - Preto</h5>
                    <p class="card-text">R$ 209,99
                        até 5x de R$ 42,00</p>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Nike Air Max.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">TTênis Nike Air Max Infuriate III Low Masculino - Prata</h5>
                    <p class="card-text">R$ 299,99
                        até 7x de R$ 42,86</p>
                    <a href="file:///C:/Users/marco/Desktop/prototipo.git/trunk/MCZ%20SHOES%20-login.html" class="btn btn-danger">Comprar<i class="fa fa-cart-arrow-down"></i></a>
                </div>
            </div>
        ...
        <div class="col-3">
            <div class="card">
                <img src="/img/Tênis Adidas Pro Next.jpg" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title">Tênis Adidas Pro Next 2019 Masculino - Preto e Branco</h5>
